function [PQ,PV,nPQ,nPV,V_mag,V_Delta,P_cal,Q_cal,Y_mat,Theta,Y_mag,B,G,Pij,Qij,Pji,Qji]= LU_NRaphsonpowerflow(S_Base,No_of_Buses,No_of_Lines,Bus_data,Line_data)
